...
@Component({
  selector: 'app-exhibitor-reg',
  templateUrl: './exhibitor-reg.component.html',
  styleUrls: ['./exhibitor-reg.component.css']
})
export class ExhibitorRegComponent implements OnInit {
  EventData: any = [] = [];
  formGroup: FormGroup;
  @Input() exhibitor = {
    name: '',
  ...
  onSubmit() {
    this.restApi.getExhibitor(this.exhibitor).subscribe((data: {}) => {
    })
